...
echo '<div class="caseListe grid-columns-span-6">Liste des Lignespaniers </div>';
...
echo '<div class="caseListe">IdArticle</div>';
echo '<div class="caseListe">IdPanier</div>';
...
{
echo '<div class="caseListe">'.$unObjet->getIdArticle().'</div>';
echo '<div class="caseListe">'.$unObjet->getIdPanier().'</div>';
