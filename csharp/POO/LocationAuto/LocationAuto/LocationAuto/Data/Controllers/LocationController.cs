...
namespace LocationAuto.Data.Controllers
{
    ...
    public class LocationController : ControllerBase
    {
        ...
        [HttpGet]
        public ActionResult<IEnumerable<LocationDTO>> GetAllLocation()
        {
            IEnumerable<Location> listeLocation = _service.GetAllLocation();
            return Ok(_mapper.Map<IEnumerable<LocationDTO>>(listeLocation));
        }
        ...
        public ActionResult<LocationDTO> GetLocationById(int id)
        {
            ...
            if (commandItem != null)
            {
                return Ok(_mapper.Map<LocationDTO>(commandItem));
            }
            return NotFound();
        }
        ...
        [HttpPost]
        public ActionResult<LocationDTO> CreateLocation(Location obj)
        {
            _service.AddLocation(obj);
            return CreatedAtRoute(nameof(GetLocationById), new { Id = obj.IdLocation }, obj);
        }
