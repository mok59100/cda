...
INSERT INTO `groupes` VALUES (1,'TheGroup',3,'logo1.jpg'),(2,'Meilleur Groupe',300,'logo2.png');
...
CREATE TABLE `musiciens` (
  ...
  KEY `FK_Musiciens_Groupes` (`IdGroupe`),
  CONSTRAINT `FK_Musiciens_Groupes` FOREIGN KEY (`IdGroupe`) REFERENCES `groupes` (`IdGroupe`)
...
INSERT INTO `musiciens` VALUES (1,'Dupond','Toto','guitare',1),(4,'Durand','Tititoto','batterie',2),(6,'dgsds','gsdsd','dgsgsd',1);
