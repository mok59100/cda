...
--
-- Host: localhost    Database: gestionlivres
-- ------------------------------------------------------
...
--
-- Current Database: `gestionlivres`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `gestionlivres` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `abonnes` (
  ...
  `date_d_adhesion` datetime DEFAULT NULL,
...
INSERT INTO `abonnes` VALUES (1,'yre','v','b',3,'2021-11-01 12:12:55','2021-11-01 12:12:55','s');
...
CREATE TABLE `choisi` (
  ...
  CONSTRAINT `FK_choisi_abonnes` FOREIGN KEY (`Id_abonnes`) REFERENCES `abonnes` (`IdAbonne`),
...
CREATE TABLE `detenu` (
  ...
  CONSTRAINT `FK_detenu_abonnes` FOREIGN KEY (`Id_abonnes`) REFERENCES `abonnes` (`IdAbonne`),
...
-- Dump completed on 2021-12-05 17:25:16
