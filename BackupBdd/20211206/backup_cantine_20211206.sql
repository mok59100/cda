...
--
-- Table structure for table `menusdujour`
--

DROP TABLE IF EXISTS `menusdujour`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `menusdujour` (
  ...
  KEY `FK_MenusDuJour_Menus` (`IdMenu`),
  CONSTRAINT `FK_MenusDuJour_Menus` FOREIGN KEY (`IdMenu`) REFERENCES `menus` (`IdMenu`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `menusdujour`
--

LOCK TABLES `menusdujour` WRITE;
/*!40000 ALTER TABLE `menusdujour` DISABLE KEYS */;
/*!40000 ALTER TABLE `menusdujour` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `reglements` (
  ...
  KEY `FK_Reglements_Menus` (`IdMenu`),
  ...
  CONSTRAINT `FK_Reglements_Menus` FOREIGN KEY (`IdMenu`) REFERENCES `menus` (`IdMenu`),
...
CREATE TABLE `reservations` (
  ...
  KEY `FK_Reservation_Menus` (`IdMenu`),
  KEY `FK_Reservation_Eleves` (`IdUtilisateur`),
  CONSTRAINT `FK_Reservation_Eleves` FOREIGN KEY (`IdUtilisateur`) REFERENCES `eleves` (`IdUtilisateur`),
  CONSTRAINT `FK_Reservation_Menus` FOREIGN KEY (`IdMenu`) REFERENCES `menus` (`IdMenu`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
