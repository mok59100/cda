...
echo '<div class="caseListe titreListe grid-columns-span-10">Liste des Mavue </div>';
...
echo '<div class="caseListe labelListe">Mar_nom</div>';
...
echo '<div class="caseListe donneeListe">'.$unObjet->getMar_nom().'</div>';
echo '<div class="caseListe"> <a href="index.php?page=FormMavue&mode=Afficher&id='.$unObjet->getMod_id().'"><i class="fas fa-file-contract"></i></a></div>';
                                                    
echo '<div class="caseListe"> <a href="index.php?page=FormMavue&mode=Modifier&id='.$unObjet->getMod_id().'"><i class="fas fa-pen"></i></a></div>';
                                                    
echo '<div class="caseListe"> <a href="index.php?page=FormMavue&mode=Supprimer&id='.$unObjet->getMod_id().'"><i class="fas fa-trash-alt"></i></a></div>';
}
