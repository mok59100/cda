...
if (isset($_GET['id'])) {
	$elm = ModelesManager::findById($_GET['id']);
} else {
	$elm = new Modeles();
}
echo '<main class="center">';

echo '<form class="GridForm" action="index.php?page=ActionModeles&mode='.$_GET['mode'].'" method="post"/>';

echo '<div class="caseForm titreForm col-span-form">Formulaire Modeles</div>';
...
echo '<div class="caseForm col-span-form">
	<div></div>
	<div><a href="index.php?page=ListeModeles"><button type="button"><i class="fas fa-sign-out-alt fa-rotate-180"></i></button></a></div>
