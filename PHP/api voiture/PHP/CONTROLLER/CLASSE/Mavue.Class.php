...
class Mavue 
{
	...
	private $_mar_nom;
	private static $_attributes=["mod_id","mod_mar_id","mod_nom","mod_cylindree","mod_prix","mod_date_dispo","mod_date_ajout","mar_nom"];
	/***************** Accesseurs ***************** */
	...
	*/
	...
	{
		return "Mod_id : ".$this->getMod_id()."Mod_mar_id : ".$this->getMod_mar_id()."Mod_nom : ".$this->getMod_nom()."Mod_cylindree : ".$this->getMod_cylindree()."Mod_prix : ".$this->getMod_prix()."Mod_date_dispo : ".$this->getMod_date_dispo()."Mod_date_ajout : ".$this->getMod_date_ajout()."Mar_nom : ".$this->getMar_nom()."\n";
	}
}