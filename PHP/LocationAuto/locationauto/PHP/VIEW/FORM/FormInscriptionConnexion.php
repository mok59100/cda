...
<main>
    ...
    <section class="center colonne">
        <form action="index.php?page=ActionInscription" method="POST">
            ...
            <label for="telephone"><?php echo texte('telephone') ?> * : </label>
            <input type="text" id="telephone" name="telephone" pattern="^<?php echo $regex["tel"] ?>$" required title="Renseigner votre telephone">
