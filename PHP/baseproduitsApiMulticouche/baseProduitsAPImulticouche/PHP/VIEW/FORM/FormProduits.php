...
echo '<label for=LibelleProduit class="caseForm labelForm">'.texte("LibelleProduit").'</label>';
...
echo '<label for=Prix class="caseForm labelForm">'.texte("Prix").'</label>';
echo '<div class="caseForm donneeForm"><input type="text" '.$disabled .'value="'.$elm->getPrix().'" name=Prix pattern="'.$regex["*"].'"></div>';
echo '<div class="caseForm infoForm"><i class="fas fa-question-circle"></i></div>';
echo '<div class="caseForm checkForm"><i class="fas fa-check-circle"></i></div>';

echo '<label for=DateDePeremption class="caseForm labelForm">'.texte("DateDePeremption").'</label>';
...
echo '<label for=IdCategorie class="caseForm labelForm">'.texte("IdCategorie").'</label>';
