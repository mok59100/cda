...
class Produits 
{
	...
	private $_image;
	private static $_attributes=["idProduit","libelleProduit","prix","dateDePeremption","idCategorie","image"];
	/***************** Accesseurs ***************** */
	...
	*/
	...
	{
		return "IdProduit : ".$this->getIdProduit()."LibelleProduit : ".$this->getLibelleProduit()."Prix : ".$this->getPrix()."DateDePeremption : ".$this->getDateDePeremption()."IdCategorie : ".$this->getIdCategorie()."Image : ".$this->getImage()."\n";
	}
}