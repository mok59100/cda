...
class Mavue 
{
	...
	private static $_attributes=["idProduit","libelleProduit","prix","dateDePeremption","idCategorie","image","libelleCategorie"];
	/***************** Accesseurs ***************** */
	...
	*/
	...
	{
		return "IdProduit : ".$this->getIdProduit()."LibelleProduit : ".$this->getLibelleProduit()."Prix : ".$this->getPrix()."DateDePeremption : ".$this->getDateDePeremption()."IdCategorie : ".$this->getIdCategorie()."Image : ".$this->getImage()."LibelleCategorie : ".$this->getLibelleCategorie()."\n";
	}
}